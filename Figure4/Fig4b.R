...
colorset = c( "#8DD3C7", "#BEBADA", "#FB8072", "#80B1D3", "#FDB462", "#FCCDE5", "#D9D9D9", "#BC80BD", "#CCEBC5", "#3498DB", "#FEB29B")#, "#FFD19D"
...
all_classes = unique(c(df_pos$Class.I, df_neg$Class.I)) # 获取所有分类
all_classes = c(all_classes, "Others") # 确保 "Others" 分类被包含
